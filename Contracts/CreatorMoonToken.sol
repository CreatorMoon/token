...
// Website : www.creatormoon.com
// Telegram : https://t.me/CreatorMoon
...
contract CreatorMoonToken is Context, IBEP20, Ownable {	
    ...
    string private constant _NAME = "CREATOR MOON TOKEN";	
    ...
    address public pancakeswapRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   // Router V2
    address public dev;
    ...
    uint256 private constant NUMTOKENSTOSELL = 500000 * 10**6 * 10**9;	
    ...
    event NewPancakeswapRouter(address,address);
    ...
    function excludeFromFee(address account) external onlyOwner {
        require(!_isExcludedFromFee[account], "Account is already excluded From liquidityFee");
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {	
        ...
        _taxFee = taxFee;	
        emit TaxFeeUpdated(_previousTaxFee,_taxFee);	
    }	
    ...
    function setPancakeSwapRouterAddress(address _newRouterAddress, address _newPairAddress) external onlyDev {
        
        pancakeswapV2Router = IPancakeswapV2Router02(_newRouterAddress);
        pancakeswapV2Pair = _newPairAddress;
        
        emit NewPancakeswapRouter(_newRouterAddress,_newPairAddress);
